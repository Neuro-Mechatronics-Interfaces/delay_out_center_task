...
state_transitions \
    ...
    + [ # Overshoot states
       dict(trigger='target_disengaged', source='hold_a',       dest='overshoot_a'),
       #dict(trigger='target_overshoot',  source='hold_a',       dest='overshoot_a'),
       dict(trigger='target_engaged',    source='overshoot_a',  dest='hold_a'),
       dict(trigger='timeout',           source='overshoot_a',  dest='failure'),
       dict(trigger='target_disengaged', source='hold_b',       dest='overshoot_b'),
       #dict(trigger='target_overshoot',  source='hold_b',       dest='overshoot_b'),
       dict(trigger='target_engaged',    source='overshoot_b',  dest='hold_b'),
       dict(trigger='timeout',           source='overshoot_b',  dest='failure'),
       dict(trigger='target_disengaged', source='hold_c',       dest='overshoot_c'),
       #dict(trigger='target_overshoot',  source='hold_c',       dest='overshoot_c'),
       dict(trigger='target_engaged',    source='overshoot_c',  dest='hold_c'),
       dict(trigger='timeout',           source='overshoot_c',  dest='failure'),
      ]
"""
